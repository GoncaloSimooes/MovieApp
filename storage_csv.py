...
class StorageCsv(IStorage):
    ...
    def data_api(self, title_movie):
        """Makes a request to the OMDB API and returns the CSV response."""
    ...
    def save_movies(self, movies):
        """Saves the list of dictionaries in the CSV file."""
        fieldnames = ["title", "year", "rating", "poster_url", "imdb_ID"]
